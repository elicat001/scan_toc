  ...
  return (
    <div className="bg-white rounded-[2.5rem] p-7 shadow-sm border border-gray-100">
      <div className="flex justify-between items-center mb-6">
        <h4 className="font-black text-gray-900 text-sm italic">Items Detail</h4>
        <span className="text-[10px] text-gray-400 font-black uppercase tracking-widest">{itemCount} items</span>
      </div>
          ...
          <div key={idx} className="flex gap-4">
            ...
            <div className="flex-1 min-w-0 flex flex-col justify-center">
              ...
              <div className="flex justify-between items-center mt-1">
                <span className="text-[9px] text-gray-400 font-black uppercase">Standard Size</span>
      ...
      <div className="mt-8 space-y-1">
        ...
        {diningMode === 'delivery' && (
          <div className="flex justify-between items-center py-4 border-t border-dashed border-gray-100">
            <span className="text-[10px] text-gray-400 font-black uppercase tracking-widest">Delivery Fee</span>
        ...
        <div className="flex justify-between items-end pt-6 border-t border-gray-50">
          <div>
            ...
            <span className="text-[10px] text-gray-400 font-black uppercase tracking-[0.2em] block">Summary Total</span>
          </div>
